      ...
      <table className="mt-2 w-full text-left text-sm">
        <thead>
          <tr className="text-xs uppercase text-[var(--text-3)]">
            ...
            <th className="text-right">{feesCopy.buy}</th>
            <th className="text-right">{feesCopy.sellMaker}</th>
            <th className="text-right">{feesCopy.sellTaker}</th>
          </tr>
        </thead>
        <tbody>
          <tr className="border-t border-[var(--border)]">
            ...
            <td className="text-right font-bold text-[var(--yes)]">{feesCopy.free}</td>
            <td className="text-right font-bold">{sell}</td>
            <td className="text-right font-bold">{sell}</td>
          </tr>
        </tbody>
      </table>
      <p className="mt-2 text-xs text-[var(--text-3)]">{feesCopy.makerTakerHint}</p>
